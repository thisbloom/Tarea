                ...
                <div class="row">
                    ...
                    <div class="col-md-auto ">
                        <ul class="list-inline">
                            <li class="list-inline-item"> <img src="{{asset("storage/".$curso["img_curso"])}}" alt="DP" class=" rounded-circle img-fluid " width="35" height="35"> </li>
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" />
                            ...
                            <div class="col-md-6 align-self-center">
                                <h1>404</h1>
                                <h2>UH OH! </h2>
                                <p>Parece que no tienes cursos creados ve a la pestaña de <a href="{{ url('/crearcursos') }}">creación de cursos</a> para crear tu primer curso
                            </div>
                        </div>
                    </div>
                </main>

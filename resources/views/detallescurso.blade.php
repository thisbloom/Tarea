                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://imgur.com/4yN09n2.jpg" alt="Curso" class="rounded-circle" width="150">
                                <div class="mt-3">
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    @foreach($res as $user) @if($curso["creador_curso"]==$user["id"]) <button class="btn btn-primary" href="/#">Comprar</button> @endif @endforeach
                                    @foreach($res as $user) @if($curso["creador_curso"]==$user["id"]) <button class="btn btn-outline-primary" href="/#">Editar</button> @endif @endforeach
